...
function MainSidebar({ sidebarOpen, setSidebarOpen }) {
      ...
      >
        ...
        <div className="space-y-8">
          ...
          <div>
            ...
            <ul className="mt-3">
              {/* Dashboard */}
              <SidebarLinks activecondition={pathname === '/' || pathname.includes('dashboard')}>
                {(handleClick, open) => {
                  return (
                    <React.Fragment>
                      <a
              ...
              {/* E-Commerce */}
              <SidebarLinks activecondition={pathname.includes('ecommerce')}>
                {(handleClick, open) => {
                  return (
                    <React.Fragment>
                      <a
              ...
              {/* Community */}
              <SidebarLinks activecondition={pathname.includes('community')}>
                {(handleClick, open) => {
                  return (
                    <React.Fragment>
                      <a
              ...
              {/* Finance */}
              <SidebarLinks activecondition={pathname.includes('finance')}>
                {(handleClick, open) => {
                  return (
                    <React.Fragment>
                      <a
              ...
              {/* Job Board */}
              <SidebarLinks activecondition={pathname.includes('job')}>
                {(handleClick, open) => {
                  return (
                    <React.Fragment>
                      <a
              ...
              {/* Tasks */}
              <SidebarLinks activecondition={pathname.includes('tasks')}>
                {(handleClick, open) => {
                  return (
                    <React.Fragment>
                      <a
              ...
              {/* Settings */}
              <SidebarLinks activecondition={pathname.includes('settings')}>
                {(handleClick, open) => {
                  return (
                    <React.Fragment>
                      <a
              ...
              {/* Utility */}
              <SidebarLinks activecondition={pathname.includes('utility')}>
                {(handleClick, open) => {
                  return (
                    <React.Fragment>
                      <a
          ...
          <div>
            ...
            <ul className="mt-3">
              ...
              {/* Components */}
              <SidebarLinks activecondition={pathname.includes('component')}>
                {(handleClick, open) => {
                  return (
                    <React.Fragment>
                      <a
